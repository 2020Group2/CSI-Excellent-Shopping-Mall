...
var aim_url = "http://129.204.216.249:8000/selllist/"+ userid + ""
$.ajax({
    type:"get",
    url: aim_url,
...
function printinfo(data){
    ...
    for(var i = 0;i<t; i++){
        var showitem = document.getElementsByClassName("product-list-itemsold")[i];
