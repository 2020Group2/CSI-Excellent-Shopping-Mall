function getLike(){
    ...
    var aim_url = "http://129.204.216.249:8000/get/like/"+ userid + ""
    $.ajax({
        type:"get",
        url: aim_url,
    ...
    function printinfo(data){
        ...
        for(var i = 0;i<t; i++){
            var showitem = document.getElementsByClassName("product-list-itemlike")[i];
        ...
        for(var i=8,j=24,k=0;i<8+t;i++,j++,k++){
